...
DROP TABLE IF EXISTS tags_meal, recipe_category, meal_image, recipe_image, user_meal, user_recipe, users, tags, recipe, image, meal, category;
...
CREATE TABLE user_meal (
	...
	meal_id int REFERENCES meal(meal_id),
	CONSTRAINT PK_user_meal PRIMARY KEY (user_id, meal_id)
);
